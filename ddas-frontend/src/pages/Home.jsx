...
// // //             Join thousands of organizations already saving resources with DDAS. 
// // //             Start your free trial today and experience intelligent duplicate detection.
// // //           </p>
// // //           <div className="flex flex-col sm:flex-row gap-4 justify-center">
// // //             <button className="bg-white text-blue-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transform hover:-translate-y-1 transition-all duration-300 shadow-lg">
// // //               Start Free Trial
// // //             </button>
...
// // const Home = () => {
// //   return (
// //     <div className="w-full min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 m-0 p-0">
// //       {/* Hero Section */}
// //       <div className="relative overflow-hidden w-full">
// //         <div className="absolute inset-0 bg-gradient-to-r from-blue-600/10 to-indigo-600/10 w-full"></div>
...
// //       {/* Stats Section */}
// //       <div className="py-16 bg-white/80 backdrop-blur-sm w-full">
...
// //       {/* How It Works Section */}
// //       <div className="py-20 bg-gradient-to-r from-gray-50 to-blue-50 w-full">
// //         <div className="w-full px-4 sm:px-6 lg:px-8">
// //           <div className="text-center mb-16">
// //             <h2 className="text-4xl font-bold text-gray-900 mb-4">
// //               How DDAS Works
...
// //       {/* CTA Section */}
// //       <div className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600 text-white w-full">
